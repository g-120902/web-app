...
export default function UserBox(email: any): JSX.Element {
    ...
    return (
        <div className="text-7xlselect-none font-primary-bold flex flex-col px-10 py-12 gap-10 bg-base-gray w-1/2 mx-auto shadow-black shadow-lg border-2 border-neon">
